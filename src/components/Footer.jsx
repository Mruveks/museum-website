...
import { AiOutlineInstagram, AiOutlineFacebook, AiOutlineTwitter, AiOutlineYoutube, AiFillMediumSquare } from 'react-icons/ai'
const Footer = () => {
  return (
    <footer className="text-md mt-20">
          ...
          <ul className="grid items-center border-t border-gray-400 bg-gray-200 h-40 col-span-2 px-14">
            <form className="flex space-x-4 w-full h-14">
              ...
              <span className="flex w-[80%] space-x-4">
                <input type="email" placeholder="Enter your email" className="w-[80%] bg-white px-2"></input>
                <button  className="border-2 rounded-lg border-black px-4 text-lg">Sign Up</button>
              </span>
            </form>
          </ul>
      </div>
      ...
      <div className="flex justify-between items-center border-t border-gray-400 h-10 px-4">
        ...
        <a href="#" className="mr-0">2023 Kuba Mrowiec</a>
      </div>
    </footer>
  );
};
